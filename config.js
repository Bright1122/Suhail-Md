...
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "233597544298";
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "Bright",
  packname: process.env.PACK_NAME || "Larry",
  botname : process.env.BOT_NAME  || "Bright Larry",
